...
为了在 app 中响应用户的消息，开发者需要创建一个 wechat responder controller. 首先在 router 中定义

```ruby
  get ':weixin_secret_key' => 'services#index', as: :server
  post ':weixin_secret_key'=> 'services#reply', as: :reply
```
